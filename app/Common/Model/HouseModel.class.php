...
class HouseModel extends Model {
    ...
    protected $_validate = array (
		...
		/*array('time','require','选择入住时间', 1,'',1),	
		array('end','require','输入活动结束时间', 1,'',1),	
		array('toilets','require','输入马桶数', 1,'',1),	
		array('parks','require','输入停车位数', 1,'',1),	
		array('showers','require','输入淋浴数', 1,'',1),	
		array('price','require','输入租金', 1,'',1),	*/
    );	
